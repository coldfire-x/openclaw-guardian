...
async function main(): Promise<void> {
  ...
  const telegram = new TelegramApprovalBot(config.telegram.enabled, config.telegram.bot_token, config.telegram.proxy, store, config.openclaw.process_name, config.openclaw.log_path, config);
